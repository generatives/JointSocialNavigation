...
def generate_launch_description():
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        "rviz_config_file",
        default_value=os.path.join(social_simulator_dir, "rviz", "default_sim_view.rviz"),
    ...
    declare_world_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(social_simulator_dir, "worlds", "doors_hallway.world"),
    ...
    start_gazebo_server_cmd = ExecuteProcess(
        ...
        cmd=[
            ...
            "--ros-args",
            "--params-file",
            os.path.join(social_simulator_dir, "params", "gazebo.yaml"),
        ],
        cwd=[launch_dir],
        output="screen",
    )
